ALTER TABLE BIADMIN.BI_CLAIMS_LOSSES_PAID_FACT
 DROP PRIMARY KEY CASCADE;

DROP TABLE BIADMIN.BI_CLAIMS_LOSSES_PAID_FACT CASCADE CONSTRAINTS;

CREATE TABLE BIADMIN.BI_CLAIMS_LOSSES_PAID_FACT
(
  CLAIM_REC           NUMBER(12),
  POLICY_ID           NUMBER,
  LINE_CODE           NUMBER,
...
--  There is no statement for index BIADMIN.SYS_C0012826.
--  The object is created when the parent object is created.

ALTER TABLE BIADMIN.BI_CLAIMS_LOSSES_PAID_FACT ADD (
  PRIMARY KEY
  (CLAIM_REC)
  USING INDEX
    TABLESPACE USERS
...
ALTER TABLE BIADMIN.BI_CLAIMS_LOSSES_PAID_FACT ADD (
  CONSTRAINT BI_CLAIMS_LOSSES_PD_FACT_FK1 
  FOREIGN KEY (LINE_CODE) 
  REFERENCES BIADMIN.BI_LINE_DIM (LINE_CODE)
  ENABLE VALIDATE,
  CONSTRAINT BI_CLAIMS_LOSSES_PD_FACT_FK10 
  FOREIGN KEY (CLAIMS_BRANCH_CODE) 
  REFERENCES BIADMIN.BI_BRANCH_DIM (BRANCH_CODE)
  ENABLE VALIDATE,
  CONSTRAINT BI_CLAIMS_LOSSES_PD_FACT_FK2 
  FOREIGN KEY (BRANCH_CODE) 
  REFERENCES BIADMIN.BI_BRANCH_DIM (BRANCH_CODE)
  ENABLE VALIDATE,
  CONSTRAINT BI_CLAIMS_LOSSES_PD_FACT_FK3 
  FOREIGN KEY (ASSURED_CODE) 
  REFERENCES BIADMIN.BI_ASSURED_DIM (ASSURED_CODE)
  ENABLE VALIDATE,
  CONSTRAINT BI_CLAIMS_LOSSES_PD_FACT_FK4 
  FOREIGN KEY (EFFECTIVITY_DATE) 
  REFERENCES BIADMIN.BI_TIME_DIM (TIME_CODE)
  ENABLE VALIDATE,
  CONSTRAINT BI_CLAIMS_LOSSES_PD_FACT_FK5 
  FOREIGN KEY (TRAN_DATE) 
  REFERENCES BIADMIN.BI_TIME_DIM (TIME_CODE)
  ENABLE VALIDATE,
  CONSTRAINT BI_CLAIMS_LOSSES_PD_FACT_FK6 
  FOREIGN KEY (LOSS_DATE) 
  REFERENCES BIADMIN.BI_TIME_DIM (TIME_CODE)
  ENABLE VALIDATE,
  CONSTRAINT BI_CLAIMS_LOSSES_PD_FACT_FK7 
  FOREIGN KEY (FILE_DATE) 
  REFERENCES BIADMIN.BI_TIME_DIM (TIME_CODE)
  ENABLE VALIDATE,
  CONSTRAINT BI_CLAIMS_LOSSES_PD_FACT_FK8 
  FOREIGN KEY (DATE_PAID) 
  REFERENCES BIADMIN.BI_TIME_DIM (TIME_CODE)
  ENABLE VALIDATE,
  CONSTRAINT BI_CLAIMS_LOSSES_PD_FACT_FK9 
