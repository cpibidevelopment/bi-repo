DROP MATERIALIZED VIEW BIADMIN.BI_CLAIMS_BRDRX_DIST_LP_MV;
CREATE MATERIALIZED VIEW BIADMIN.BI_CLAIMS_BRDRX_DIST_LP_MV 
TABLESPACE USERS
PCTUSED    0
PCTFREE    10
INITRANS   2
...
WITH PRIMARY KEY
AS 
/* Formatted on 12/9/2016 2:24:54 PM (QP5 v5.227.12220.39754) */
SELECT *
...
COMMENT ON MATERIALIZED VIEW BIADMIN.BI_CLAIMS_BRDRX_DIST_LP_MV IS 'snapshot table for snapshot BIADMIN.BI_CLAIMS_BRDRX_DIST_LP_MV';
