CREATE MATERIALIZED VIEW BIADMIN.BI_RENEWAL_TAX_FACT_MV_TMP 
TABLESPACE USERS
PCTUSED    0
PCTFREE    10
INITRANS   2
...
WITH PRIMARY KEY
AS 
/* Formatted on 2016/08/31 11:02 (Formatter Plus v4.8.8) */
...
/*TO_CHAR (SYSDATE, 'YYYY' )TO_CHAR (fnget_check_date (a.line_cd, a.subline_cd, a.iss_cd, a.issue_yy, a.pol_seq_no, a.renew_no, 5), 'YYYYMMDD')*/
       check_spld_acct_ent_date, a.endt_seq_no, i.type_desc policy_type,
       a.cred_branch, NVL (a.endt_type, 'A') endt_type,
       ...
       get_renew_tag (a.policy_id, 'N') renewal_tag, a.expiry_tag,
       get_expdate_of_max_endtseqno (a.line_cd,
                                     a.subline_cd,
                                     a.iss_cd,
                                     a.issue_yy,
                                     a.pol_seq_no,
...
COMMENT ON MATERIALIZED VIEW BIADMIN.BI_RENEWAL_TAX_FACT_MV_TMP IS 'snapshot table for snapshot BIADMIN.BI_RENEWAL_TAX_FACT_MV_TMP';
