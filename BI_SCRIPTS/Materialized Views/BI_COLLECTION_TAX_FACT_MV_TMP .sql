...
WITH PRIMARY KEY
AS 
/* Formatted on 2016/08/25 14:59 (Formatter Plus v4.8.8) */
SELECT   h.intm_no, UPPER (h.intm_name) intm_name, b.policy_id, j.iss_name,
         a.b140_iss_cd, a.b140_prem_seq_no, UPPER (l.assd_name) assd_name,
         SUM (NVL (a.premium_amt, 0) * (NVL (g.share_percentage, 100) / 100)
             ) premium,
         c.tran_class, i.line_cd, i.line_name, b.subline_cd, k.subline_name,
         f.assd_no, c.posting_date posting_date, c.tran_id, a.gacc_tran_id,
         c.tran_date tran_date, c.tran_flag,
         ...
         g.share_percentage, TRUNC (d.due_date) due_date,
         b.pol_flag pol_flag_code, TRUNC (b.eff_date) eff_date,
